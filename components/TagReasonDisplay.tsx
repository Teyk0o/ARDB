...
const reasonLabels: Record<Language, {
  ...
  en: { usedInQuest: 'Quest(s)', usedForWorkshop: 'Workshop Upgrade', level: 'Level', usedToCraft: 'Crafting', recyclesToUseful: 'Recycles to useful material', whyKeep: 'Why Keep?', whyRecycle: 'Why Recycle?', whySell: 'Why Sell?', recycle: 'recycle', craft: 'craft' },
  fr: { usedInQuest: 'Quête(s)', usedForWorkshop: 'Amélioration atelier', level: 'Niveau', usedToCraft: 'Fabrication', recyclesToUseful: 'Recycle en matériau utile', whyKeep: 'Pourquoi garder ?', whyRecycle: 'Pourquoi recycler ?', whySell: 'Pourquoi vendre ?', recycle: 'recycler', craft: 'fabriquer' },
  de: { usedInQuest: 'Quest(s)', usedForWorkshop: 'Werkstatt-Upgrade', level: 'Stufe', usedToCraft: 'Herstellung', recyclesToUseful: 'Recycelt zu nützlichem Material', whyKeep: 'Warum behalten?', whyRecycle: 'Warum recyceln?', whySell: 'Warum verkaufen?', recycle: 'recyceln', craft: 'herstellen' },
  es: { usedInQuest: 'Misión(es)', usedForWorkshop: 'Mejora de taller', level: 'Nivel', usedToCraft: 'Fabricación', recyclesToUseful: 'Recicla a material útil', whyKeep: '¿Por qué guardar?', whyRecycle: '¿Por qué reciclar?', whySell: '¿Por qué vender?', recycle: 'reciclar', craft: 'fabricar' },
  pt: { usedInQuest: 'Missão(ões)', usedForWorkshop: 'Melhoria de oficina', level: 'Nível', usedToCraft: 'Fabricação', recyclesToUseful: 'Recicla em material útil', whyKeep: 'Por que guardar?', whyRecycle: 'Por que reciclar?', whySell: 'Por que vender?', recycle: 'reciclar', craft: 'fabricar' },
  pl: { usedInQuest: 'Quest(y)', usedForWorkshop: 'Ulepszenie warsztatu', level: 'Poziom', usedToCraft: 'Wytwarzanie', recyclesToUseful: 'Przetwarza na przydatny materiał', whyKeep: 'Dlaczego zachować?', whyRecycle: 'Dlaczego przetworzyć?', whySell: 'Dlaczego sprzedać?', recycle: 'przetworzyć', craft: 'wytworzyć' },
  no: { usedInQuest: 'Oppdrag', usedForWorkshop: 'Verkstedoppgradering', level: 'Nivå', usedToCraft: 'Laging', recyclesToUseful: 'Resirkulerer til nyttig materiale', whyKeep: 'Hvorfor beholde?', whyRecycle: 'Hvorfor resirkulere?', whySell: 'Hvorfor selge?', recycle: 'resirkulere', craft: 'lage' },
  da: { usedInQuest: 'Mission(er)', usedForWorkshop: 'Værkstedsopgradering', level: 'Niveau', usedToCraft: 'Fremstilling', recyclesToUseful: 'Genbruger til nyttigt materiale', whyKeep: 'Hvorfor beholde?', whyRecycle: 'Hvorfor genbruge?', whySell: 'Hvorfor sælge?', recycle: 'genbruge', craft: 'fremstille' },
  it: { usedInQuest: 'Missione(i)', usedForWorkshop: 'Aggiornamento laboratorio', level: 'Livello', usedToCraft: 'Fabbricazione', recyclesToUseful: 'Ricicla in materiale utile', whyKeep: 'Perché conservare?', whyRecycle: 'Perché riciclare?', whySell: 'Perché vendere?', recycle: 'riciclare', craft: 'fabbricare' },
  ru: { usedInQuest: 'Квест(ы)', usedForWorkshop: 'Улучшение мастерской', level: 'Уровень', usedToCraft: 'Создание', recyclesToUseful: 'Перерабатывается в полезный материал', whyKeep: 'Зачем сохранять?', whyRecycle: 'Зачем перерабатывать?', whySell: 'Зачем продавать?', recycle: 'переработать', craft: 'создать' },
  ja: { usedInQuest: 'クエスト', usedForWorkshop: 'ワークショップアップグレード', level: 'レベル', usedToCraft: 'クラフト', recyclesToUseful: '有用な材料にリサイクル', whyKeep: 'なぜ保管？', whyRecycle: 'なぜリサイクル？', whySell: 'なぜ売却？', recycle: 'リサイクル', craft: 'クラフト' },
  'zh-TW': { usedInQuest: '任務', usedForWorkshop: '工作坊升級', level: '等級', usedToCraft: '製作', recyclesToUseful: '回收為有用材料', whyKeep: '為什麼保留？', whyRecycle: '為什麼回收？', whySell: '為什麼出售？', recycle: '回收', craft: '製作' },
  uk: { usedInQuest: 'Квест(и)', usedForWorkshop: 'Покращення майстерні', level: 'Рівень', usedToCraft: 'Створення', recyclesToUseful: 'Переробляється в корисний матеріал', whyKeep: 'Навіщо зберігати?', whyRecycle: 'Навіщо переробляти?', whySell: 'Навіщо продавати?', recycle: 'переробити', craft: 'створити' },
  'zh-CN': { usedInQuest: '任务', usedForWorkshop: '工作坊升级', level: '等级', usedToCraft: '制作', recyclesToUseful: '回收为有用材料', whyKeep: '为什么保留？', whyRecycle: '为什么回收？', whySell: '为什么出售？', recycle: '回收', craft: '制作' },
  kr: { usedInQuest: '퀘스트', usedForWorkshop: '작업장 업그레이드', level: '레벨', usedToCraft: '제작', recyclesToUseful: '유용한 재료로 재활용', whyKeep: '왜 보관？', whyRecycle: '왜 재활용？', whySell: '왜 판매？', recycle: '재활용', craft: '제작' },
  tr: { usedInQuest: 'Görev(ler)', usedForWorkshop: 'Atölye yükseltmesi', level: 'Seviye', usedToCraft: 'Üretim', recyclesToUseful: 'Faydalı malzemeye geri dönüştürür', whyKeep: 'Neden sakla?', whyRecycle: 'Neden geri dönüştür?', whySell: 'Neden sat?', recycle: 'geri dönüştür', craft: 'üret' },
  hr: { usedInQuest: 'Zadatak/zadaci', usedForWorkshop: 'Nadogradnja radionice', level: 'Razina', usedToCraft: 'Izrada', recyclesToUseful: 'Reciklira u koristan materijal', whyKeep: 'Zašto zadržati?', whyRecycle: 'Zašto reciklirati?', whySell: 'Zašto prodati?', recycle: 'reciklirati', craft: 'izraditi' },
  sr: { usedInQuest: 'Zadatak/zadaci', usedForWorkshop: 'Nadogradnja radionice', level: 'Nivo', usedToCraft: 'Izrada', recyclesToUseful: 'Reciklira u koristan materijal', whyKeep: 'Zašto zadržati?', whyRecycle: 'Zašto reciklirati?', whySell: 'Zašto prodati?', recycle: 'reciklirati', craft: 'izraditi' }
};
